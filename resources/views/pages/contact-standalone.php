        ...
        <div class="contact-grid">
            <div class="contact-info">
                ...
                <div class="contact-item">
                    ...
                    <div class="contact-details">
                        <h3>Site Web</h3>
                        <p><a href="<?php echo $contactInfo['website']; ?>" target="_blank"><?php echo $contactInfo['website']; ?></a></p>
                    </div>
                </div>
                ...
                <div class="contact-item">
                    ...
                    <div class="contact-details">
                        <h3>Horaires</h3>
                        <p><?php echo $contactInfo['hours']; ?></p>
                    </div>
                </div>
            </div>
            ...
            <div class="contact-cta">
                <div class="cta-card">
                    ...
                    <a href="?page=incident-form" class="btn btn-primary btn-lg">
                ...
                <div class="cta-card">
                    ...
                    <a href="?page=alertes" class="btn btn-secondary">
